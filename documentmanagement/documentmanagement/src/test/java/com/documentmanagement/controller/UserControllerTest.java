...
public class UserControllerTest {
	...
	/**
	 * test case for view static user info
	 */
	@Test
	public void viewDocInfoTest() {
		Mockito.when(serviceMock.viewInfo()).thenReturn(null);
		userControllerObj.viewUserInfo();
	}
	 ...
	 */
	@Test(expected = Exception.class)
	public void updateDocStatustwithBadRequest() throws Exception {
		UserRequest userRequest = new UserRequest();
